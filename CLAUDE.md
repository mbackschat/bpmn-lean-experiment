...
| Temporal adapter, interpreter hosting, production lifecycle, replay, messaging, Activities, retries, timers, cancellation, or deployment | [TEMPORAL-EXECUTION-RESEARCH.md](docs/TEMPORAL-EXECUTION-RESEARCH.md) and the active [production lifecycle proposal](docs/TEMPORAL-PROCESS-LIFECYCLE-PROPOSAL.md) |
