...
| Active work | M2 paused after Message Start Event closure; the next increment is intentionally unselected |
...
| M2 | In progress | Cyclic control flow and Message Start are evidence-closed; the remaining base elements and platform increments await the next-increment selection |
