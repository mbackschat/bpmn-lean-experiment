...
| Active work | M3 E2 User Task assignment and form metadata |
...
| M3 | In progress | Boolean Process-data is closed; next publish User Task assignment and typed form metadata, then build the real inbox |
