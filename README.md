...
| Active work | M2 is paused after the closure-reviewed Timer Start graduation; the next increment is intentionally unselected |
...
| M2 | In progress | Cyclic control flow, Message Start, and Timer Start are evidence-closed; work is paused with the remaining base elements and platform increments unselected |
