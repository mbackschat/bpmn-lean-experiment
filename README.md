...
| Active work | M2 Message Start Event closure review |
...
| M2 | In progress | The first cyclic model is evidence-closed; Message Start implementation and evidence are complete pending closure, followed by the remaining selected base elements and platform increments |
