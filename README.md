...
| Active work | M2 cyclic-control-flow closure review |
...
| M2 | In progress | The first cyclic model now executes and replays; real Message or Timer starts and the remaining selected base elements are next |
