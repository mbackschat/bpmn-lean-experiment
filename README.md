...
| Active work | M2 Terminate End Event closure review and graduation |
...
| M2 | In progress | Cyclic control flow, Message Start, and Timer Start are evidence-closed; Terminate End implementation and evidence are complete pending closure review |
