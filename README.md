...
| Active work | M2 Process-instance search |
...
| M2 | In progress | All five engine increments, exact-version definition scheduling, and published Message Start ingress are closure-reviewed and graduated; instance search remains |
