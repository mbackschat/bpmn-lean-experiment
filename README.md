...
| BPM platform | M1 through M5 closed; M6 implemented and awaiting closure review |
| Active work | close M6 structured Human Work |
...
| M6 | In closure review | Definition-bound structured Human Work supports six field kinds, bounded server validation, multiple resolution actions, conditional input, canonical completion, and a retained expense-exception journey |
