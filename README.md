...
| Active work | M2 Message Start Event proposal preparation |
...
| M2 | In progress | The first cyclic model is evidence-closed; Message Start is the next semantic capsule, followed by the remaining selected base elements and platform increments |
