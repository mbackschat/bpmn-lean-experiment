...
| Active work | Obtain owner approval for the independently reviewed M5 flow-node frequency and duration contract before implementation |
...
| M5 | In progress | E1 committed History, Diagram position, and export are closed; flow-node frequency and duration passed proposal review and await owner approval |
