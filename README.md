...
| BPM platform | M1 through M4 closed; M5 committed execution and flow-node metrics increments closed |
| Active work | Establish a curated executable BPMN model corpus before selecting the next semantic family |
...
| M5 | In progress | E1 committed History, Diagram position, and export are closed; flow-node frequency and completed duration are implemented and await closure review |
