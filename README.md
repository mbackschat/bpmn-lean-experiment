...
| Active work | M2 Terminate End Event first-green semantic checkpoint and independent review |
...
| M2 | In progress | Cyclic control flow, Message Start, and Timer Start are evidence-closed; Terminate End Event is the active increment |
