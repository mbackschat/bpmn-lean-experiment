...
| Active work | M2 configured generic Task proposal selection |
...
| M2 | In progress | Cyclic control flow, Message Start, Timer Start, and Terminate End are evidence-closed; configured generic Task selection remains |
