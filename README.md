...
| Active work | M3 Boolean Process-data profile registration and evidence |
...
| M3 | In progress | Establish Boolean Process-data, then use a real task inbox and typed form |
