...
| Active work | M2 [configured Task extension](docs/capsules/CONFIGURED-GENERIC-TASK-PROPOSAL.md) proposal review |
...
| M2 | In progress | Cyclic control flow, Message Start, Timer Start, and Terminate End are evidence-closed; the configured Task extension proposal is selected for cold review |
