...
| Active work | M2 [configured Task extension](docs/capsules/CONFIGURED-GENERIC-TASK-PROPOSAL.md) integration-green first semantic checkpoint pending cold review |
...
| M2 | In progress | Cyclic control flow, Message Start, Timer Start, and Terminate End are evidence-closed; the configured Task extension is owner-approved and active at its first semantic checkpoint |
