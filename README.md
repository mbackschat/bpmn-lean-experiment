...
| Active work | M2 [configured Task extension](docs/capsules/CONFIGURED-GENERIC-TASK-PROPOSAL.md) implementation and evidence complete; closure review next |
...
| M2 | In progress | Cyclic control flow, Message Start, Timer Start, and Terminate End are evidence-closed; the configured Task extension is registered and evidence-complete pending closure review |
