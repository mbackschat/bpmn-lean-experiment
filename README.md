...
| Active work | Review the next M5 flow-node frequency and duration contract before implementation |
...
| M5 | In progress | E1 committed History, Diagram position, and export are closed; flow-node frequency and duration are in proposal review |
