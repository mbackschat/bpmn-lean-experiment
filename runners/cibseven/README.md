...
| [CibSevenScenarioRunner.java](src/main/java/org/bpmnlean/cibseven/CibSevenScenarioRunner.java) | Profile/schedule alignment and immutable environment-keyed engine facade |
| [CibSevenEngineScenarioRunner.java](src/main/java/org/bpmnlean/cibseven/CibSevenEngineScenarioRunner.java) | Deploy/start/query/complete engine runner, clock control, timing, and cleanup |
| [CibSevenEngineBundleFactory.java](src/main/java/org/bpmnlean/cibseven/CibSevenEngineBundleFactory.java) | Legacy-default and explicitly incident-enabled engine construction |
| [CibSevenIncidentProjector.java](src/main/java/org/bpmnlean/cibseven/CibSevenIncidentProjector.java) | Exact public job/incident partition into effect or generation-1 incident state |
| [CibSevenIncidentCommandExecutor.java](src/main/java/org/bpmnlean/cibseven/CibSevenIncidentCommandExecutor.java) | Bounded failed-job report and public retry-reset realization |
| [CibSevenIncidentRunnerTest.java](src/test/java/org/bpmnlean/cibseven/CibSevenIncidentRunnerTest.java) | Configured report, raw identity, exact restoration, success, and cleanup evidence |
