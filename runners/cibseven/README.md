...
The package script supplies the exact replacement opt-in. The command executes all nineteen answer-free CIB scenarios through their pinned `2.2.0` or `2.0.0` runners, verifies producer identity and cleanup, and replaces only content-bound CIB evidence artifacts.
