...
/**
 * Test-only realization of the mapped-success Service Task contract.
 *
 ...
 */
final class CibSevenMappedSuccessProbe implements JavaDelegate {

  static final String HANDLER_BEAN = "mappedSuccessHandler";
  static final String INPUT_NAME = "requestValue";
  static final String INPUT_VALUE = "example-input";
  static final String LOCAL_OUTPUT_NAME = "result";
  static final String LOCAL_OUTPUT_VALUE = "example-result";
  static final String PROCESS_OUTPUT_NAME = "resultValue";
  ...
  public void execute(DelegateExecution execution) {
    ...
    if (!(input instanceof String value) || !INPUT_VALUE.equals(value)) {
      throw new IllegalStateException(
          "Mapped-success input mapping did not produce the exact local string");
    }
    observedInput = value;
  ...
  void requireSuccessfulExecution() {
    if (invocations != 1 || !INPUT_VALUE.equals(observedInput)) {
      throw new IllegalStateException(
          "Mapped-success delegate did not observe one exact mapped input");
    }
  }
