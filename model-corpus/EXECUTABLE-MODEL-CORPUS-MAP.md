...
The first tranche contains 30 retained executable models and 7 exact external candidates. 30 are admitted, 7 are rejected, and 3 are eligible for the browser catalog.
The retained MVP suite covers all 30 registered executable BPMN element variants.
