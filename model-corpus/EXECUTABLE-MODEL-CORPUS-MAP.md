...
The first tranche contains 35 retained executable models and 7 exact external candidates. 35 are admitted, 7 are rejected, and 3 are eligible for the browser catalog.
The retained MVP suite covers all 35 registered executable BPMN element or semantic variants.
...
| Intermediate Catch Events | Message Intermediate Catch Event | `message-triggered-review`, `settlement-confirmation-review`, `correlated-settlement-confirmation`, `message-or-deadline-routing` |
