...
The first tranche contains 33 retained executable models and 7 exact external candidates. 33 are admitted, 7 are rejected, and 3 are eligible for the browser catalog.
The retained MVP suite covers all 33 registered executable BPMN element variants.
...
| Activities | User Task | `request-review-with-form`, `parallel-content-and-risk-review`, `parallel-work-preparation`, `expense-exception-review`, `boolean-decision-routing`, `called-process-fulfilment`, `scoped-parallel-work`, `scoped-business-error-recovery`, `timed-review-window`, `message-triggered-review`, `settlement-confirmation-review`, `applicable-review-tracks`, `message-or-deadline-routing`, `task-deadline-escalation`, `application-withdrawal-during-review`, `work-package-deadline-escalation`, `non-interrupting-work-reminder`, `request-review-rework`, `message-started-approval`, `scheduled-review-start`, `scoped-termination`, `configured-integration-review`, `mapped-business-error-review`, `ordered-batch-document-review`, `deadline-escalated-batch-review`, `parallel-risk-review-all`, `parallel-risk-review-first`, `deadline-escalated-parallel-risk-review`, `invoice-review-with-context`, `underwriting-decision-recorded` |
...
| Intermediate Catch Events | Message Intermediate Catch Event | `message-triggered-review`, `settlement-confirmation-review`, `message-or-deadline-routing` |
| Intermediate Catch Events | Message Intermediate Catch Event with a direct Data Output | `settlement-confirmation-review` |
