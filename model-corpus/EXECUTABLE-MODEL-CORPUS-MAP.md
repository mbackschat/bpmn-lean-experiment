...
The first tranche contains 29 retained executable models and 7 exact external candidates. 29 are admitted, 7 are rejected, and 3 are eligible for the browser catalog.
The retained MVP suite covers all 29 registered executable BPMN element variants.
