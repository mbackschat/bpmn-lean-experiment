...
The first tranche contains 44 retained executable models and 7 exact external candidates. 44 are admitted, 7 are rejected, and 3 are eligible for the browser catalog.
The retained MVP suite covers all 43 registered executable BPMN element or semantic variants.
...
| Withdraw an application during review | retainedScenario | interrupting-task-withdrawal-message | accepted | activity-boundary-message-message-wins | notSelected | notCatalogReady |
...
| Continue audit reminders after application review closes | retainedScenario | subprocess-termination | accepted | subscription-message-host-with-child-entry-repeat | notSelected | notCatalogReady |
...
|---|---|---|
| Process structure | Process | `request-review-with-form`, `parallel-content-and-risk-review`, `parallel-work-preparation`, `expense-exception-review`, `boolean-decision-routing`, `called-process-fulfilment`, `external-service-recording`, `scoped-parallel-work`, `scoped-business-error-recovery`, `timed-review-window`, `message-triggered-review`, `settlement-confirmation-review`, `correlated-settlement-confirmation`, `invoice-receipt-wait`, `applicable-review-tracks`, `message-or-deadline-routing`, `task-deadline-escalation`, `application-withdrawal-during-review`, `work-package-deadline-escalation`, `non-interrupting-work-reminder`, `request-review-rework`, `message-started-approval`, `scheduled-review-start`, `scoped-termination`, `configured-integration-review`, `mapped-service-result`, `mapped-business-error-review`, `ordered-batch-document-review`, `deadline-escalated-batch-review`, `parallel-risk-review-all`, `parallel-risk-review-first`, `deadline-escalated-parallel-risk-review`, `invoice-review-with-context`, `underwriting-decision-recorded`, `claim-assessment-with-input-and-decision`, `application-subscription-boundary-message`, `application-subscription-boundary-timer`, `application-subscription-subprocess-boundary-timer`, `application-subscription-subprocess-boundary-one-shot`, `application-subscription-message-host-with-child-entry`, `application-subscription-catch-message`, `application-subscription-catch-timer`, `application-subscription-receive-task`, `confirmed-travel-cancellation` |
...
| End Events | Terminate End Event | `scoped-termination`, `application-subscription-boundary-message`, `application-subscription-boundary-timer`, `application-subscription-subprocess-boundary-timer`, `application-subscription-subprocess-boundary-one-shot`, `application-subscription-message-host-with-child-entry`, `application-subscription-catch-message`, `application-subscription-catch-timer`, `application-subscription-receive-task` |
| Activities | User Task | `request-review-with-form`, `parallel-content-and-risk-review`, `parallel-work-preparation`, `expense-exception-review`, `boolean-decision-routing`, `called-process-fulfilment`, `scoped-parallel-work`, `scoped-business-error-recovery`, `timed-review-window`, `message-triggered-review`, `settlement-confirmation-review`, `correlated-settlement-confirmation`, `applicable-review-tracks`, `message-or-deadline-routing`, `task-deadline-escalation`, `application-withdrawal-during-review`, `work-package-deadline-escalation`, `non-interrupting-work-reminder`, `request-review-rework`, `message-started-approval`, `scheduled-review-start`, `scoped-termination`, `configured-integration-review`, `mapped-business-error-review`, `ordered-batch-document-review`, `deadline-escalated-batch-review`, `parallel-risk-review-all`, `parallel-risk-review-first`, `deadline-escalated-parallel-risk-review`, `invoice-review-with-context`, `underwriting-decision-recorded`, `claim-assessment-with-input-and-decision`, `application-subscription-boundary-message`, `application-subscription-boundary-timer`, `application-subscription-subprocess-boundary-timer`, `application-subscription-subprocess-boundary-one-shot`, `application-subscription-message-host-with-child-entry`, `application-subscription-catch-message`, `application-subscription-catch-timer`, `application-subscription-receive-task`, `confirmed-travel-cancellation` |
| Activities | User Task with a direct Data Input | `invoice-review-with-context` |
| Activities | User Task with direct Data Input and Output | `claim-assessment-with-input-and-decision` |
...
| Activities | Receive Task | `invoice-receipt-wait`, `application-subscription-receive-task` |
...
| Activities | Embedded Sub-Process | `scoped-parallel-work`, `scoped-business-error-recovery`, `work-package-deadline-escalation`, `scoped-termination`, `application-subscription-boundary-message`, `application-subscription-boundary-timer`, `application-subscription-subprocess-boundary-timer`, `application-subscription-subprocess-boundary-one-shot`, `application-subscription-message-host-with-child-entry`, `application-subscription-catch-message`, `application-subscription-catch-timer`, `application-subscription-receive-task`, `confirmed-travel-cancellation` |
| Compensation | Compensation Boundary Event | `confirmed-travel-cancellation` |
| Compensation | Global synchronous Compensation Intermediate Throw Event | `confirmed-travel-cancellation` |
| Compensation | Compensation Event Sub-Process | `confirmed-travel-cancellation` |
| Compensation | Single-effect Compensation handler Service Task | `confirmed-travel-cancellation` |
| Gateways | Exclusive Gateway | `expense-exception-review`, `boolean-decision-routing`, `request-review-rework` |
| Gateways | Parallel Gateway | `parallel-content-and-risk-review`, `parallel-work-preparation`, `scoped-parallel-work`, `scoped-business-error-recovery`, `scoped-termination`, `application-subscription-boundary-message`, `application-subscription-boundary-timer`, `application-subscription-subprocess-boundary-timer`, `application-subscription-subprocess-boundary-one-shot`, `application-subscription-message-host-with-child-entry`, `application-subscription-catch-message`, `application-subscription-catch-timer`, `application-subscription-receive-task`, `confirmed-travel-cancellation` |
| Gateways | Inclusive Gateway | `applicable-review-tracks` |
| Gateways | Event-Based Gateway | `message-or-deadline-routing` |
| Intermediate Catch Events | Message Intermediate Catch Event | `message-triggered-review`, `settlement-confirmation-review`, `correlated-settlement-confirmation`, `message-or-deadline-routing`, `application-subscription-catch-message` |
| Intermediate Catch Events | Message Intermediate Catch Event with a direct Data Output | `settlement-confirmation-review`, `correlated-settlement-confirmation` |
| Message correlation | Definition-scoped Message key correlation | `correlated-settlement-confirmation` |
| Intermediate Catch Events | Timer Intermediate Catch Event | `timed-review-window`, `message-or-deadline-routing`, `application-subscription-catch-timer` |
| Boundary Events | Interrupting Timer Boundary Event on User Task | `task-deadline-escalation` |
| Boundary Events | Interrupting Message Boundary Event on User Task | `application-withdrawal-during-review` |
...
| Boundary Events | Non-interrupting Message Boundary Event on User Task | `application-subscription-boundary-message`, `application-subscription-message-host-with-child-entry` |
| Boundary Events | Recurring non-interrupting Timer Boundary Event on User Task | `application-subscription-boundary-timer` |
| Boundary Events | Recurring non-interrupting Timer Boundary Event on Sub-Process | `application-subscription-subprocess-boundary-timer` |
| Boundary Events | Non-interrupting Timer Boundary Event on Sub-Process | `application-subscription-subprocess-boundary-one-shot` |
...
| 4 | `taskMetadata` | 3 | 4 |
| 5 | `lanePresentation` | 2 | 3 |
| 6 | `scriptTaskExecution` | 2 | 2 |
| 7 | `businessDecision` | 1 | 2 |
| 8 | `genericTask` | 1 | 1 |
| 9 | `resourceAssignment` | 1 | 1 |
| 10 | `sendTaskDelivery` | 1 | 1 |
| 11 | `signalEvent` | 1 | 1 |
