...
This private development package owns the live Temporal refinement, cancellation, and browser acceptance witnesses required by the [definition-scheduling specification](../../docs/BPM-PLATFORM-DEFINITION-SCHEDULING-SPEC.md#required-evidence) for the [M2 showcase](../../docs/PLAN.md#m2--the-file-runs-its-real-shape). It contains test composition only and adds no production API or behavior.
