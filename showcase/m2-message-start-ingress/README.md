...
This private development package owns the live Temporal refinement and browser acceptance witnesses required by the [Message Start ingress specification](../../docs/BPM-PLATFORM-MESSAGE-INGRESS-SPEC.md#stable-rules-and-evidence) for the [M2 showcase](../../docs/PLAN.md#m2--the-file-runs-its-real-shape). It contains test composition only and adds no production API or behavior.
