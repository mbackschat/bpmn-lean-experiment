...
| Check the internal-commutation census | [`internal-commutation-census.test.ts`](internal-commutation-census.test.ts) | Keep both semantic accounts and the reviewed proposal exhaustive over operation families and RuntimeState atom domains. |
