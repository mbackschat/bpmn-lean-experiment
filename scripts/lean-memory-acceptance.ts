  ...
  receipts: [
    {
      ...
      outputSha256: "fe812e937bf9d73be49a2b1a69a77b28790dc06a28d06c9c556cb3c6fa69f8cd",
      exitStatus: 0,
      cgroupPeakBytes: 43_171_840,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
    {
      command: "./scripts/lake.sh build",
      measuredAtCommit: "5fa6dfe3",
      outputSha256: "4f567059c83dca3b1b9ffbbc39d5b9d271d0162dfbde274d951b9dc03891cd21",
      exitStatus: 0,
      cgroupPeakBytes: 41_222_144,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
  ],
