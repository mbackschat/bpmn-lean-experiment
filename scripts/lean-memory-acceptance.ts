  ...
  receipts: [
    {
      ...
      outputSha256: "5fa968103e69ea2b59b487fccfe92da90795ac0ecb94a672aed7248f70e0f94a",
      exitStatus: 0,
      cgroupPeakBytes: 41_607_168,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
    {
      command: "./scripts/lake.sh build",
      measuredAtCommit: "e9c9db0f",
      outputSha256: "9d79233d5ddf6e2906a58cd18d2425a18ea73a5549a691b59bdb4930ed76c96f",
      exitStatus: 0,
      cgroupPeakBytes: 41_705_472,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
  ],
