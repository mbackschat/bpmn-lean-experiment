  ...
  receipts: [
    {
      ...
      outputSha256: "6c53dad040c90367e6583c9a37d2c5280034e1adf837a205778b077b75139d40",
      exitStatus: 0,
      cgroupPeakBytes: 41_410_560,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
    {
      command: "./scripts/lake.sh build",
      measuredAtCommit: "fe934e3c",
      outputSha256: "bcbbf734a71ec4050d6aa326781f706485403162ed088573c5c34673008ff5b0",
      exitStatus: 0,
      cgroupPeakBytes: 41_287_680,
      memoryEvents: { high: 0, max: 0, oom: 0, oom_kill: 0, oom_group_kill: 0 },
    },
  ],
