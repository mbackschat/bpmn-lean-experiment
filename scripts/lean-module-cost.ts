...
export const leanModuleCostRecord = {
  ...
  nearCapModules: [
    ...
    "BpmnSemantics.ServiceTaskIncidentCancellationConformance",
  ],
  rows: [
    { module: "BpmnSemantics.MessageStartConformance", peakResidentKib: 3414952, elapsedSeconds: 28.6 },
    { module: "BpmnSemantics.SequentialMultiInstanceConformance", peakResidentKib: 3399904, elapsedSeconds: 29.3 },
    { module: "BpmnSemantics.FlowNodeOccurrenceLifecycleConformance", peakResidentKib: 3318456, elapsedSeconds: 43.0 },
    { module: "BpmnSemantics.RuntimeStateWellFormedConformance", peakResidentKib: 3063008, elapsedSeconds: 31.0 },
    { module: "BpmnSemantics.SequentialMultiInstanceProgramBindingConformance", peakResidentKib: 2969072, elapsedSeconds: 28.7 },
    { module: "BpmnSemantics.CallActivityConformance", peakResidentKib: 2898756, elapsedSeconds: 21.5 },
    { module: "BpmnSemantics.TimerStartConformance", peakResidentKib: 2881092, elapsedSeconds: 21.9 },
    { module: "BpmnSemantics.ServiceTaskIncidentCancellationConformance", peakResidentKib: 2860252, elapsedSeconds: 25.2 },
    { module: "BpmnSemantics.SemanticProcessAdmissionConformance", peakResidentKib: 2795928, elapsedSeconds: 19.4 },
    ...
    { module: "BpmnSemantics.CommittedExecutionPublicationConformance", peakResidentKib: 2297664, elapsedSeconds: 13.6 },
    { module: "BpmnSemantics.IntermediateCatchMessageConformance", peakResidentKib: 2225108, elapsedSeconds: 11.7 },
    { module: "BpmnSemantics.TerminateEndEventConformance", peakResidentKib: 2209880, elapsedSeconds: 17.1 },
    ...
    { module: "BpmnSemantics.MappedSuccessConformance", peakResidentKib: 2124252, elapsedSeconds: 11.5 },
    ...
    { module: "BpmnSemantics.InternalCommutationConformance", peakResidentKib: 1743512, elapsedSeconds: 7.8 },
    { module: "BpmnSemantics.UserTaskMetadataConformance", peakResidentKib: 1687096, elapsedSeconds: 7.0 },
    ...
    { module: "BpmnSemantics.StructuredHumanWorkConformance", peakResidentKib: 1013112, elapsedSeconds: 2.8 },
    ...
    { module: "BpmnSemantics.ParallelMultiInstanceConformance", peakResidentKib: 863052, elapsedSeconds: 2.3 },
