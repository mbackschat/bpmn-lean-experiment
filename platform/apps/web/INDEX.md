...
| Flow-node metrics | `flow-node-metrics-panel.tsx`, `flow-node-metrics-load.ts`, `flow-node-metric-overlay.ts` | [Flow-node occurrence metrics proposal](../../../docs/capsules/FLOW-NODE-OCCURRENCE-METRICS-PROPOSAL.md) |
