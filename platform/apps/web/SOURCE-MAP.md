...
| Definition triggers | `definition-schedule-*`, `message-start-publication-*`, `correlated-message-*`, `definition-workspace.tsx` | [Message key-correlation proposal](../../../docs/capsules/MESSAGE-KEY-CORRELATION-PROPOSAL.md), the applicable semantic specifications, and the [UI design specification](../../../docs/BPM-PLATFORM-UI-DESIGN-SPEC.md) |
