...
| Definitions and exact-version start | `definitions-api.ts`, `definition-workspace.tsx`, `deferred-definition-workspace.tsx`, `exact-definition.ts`, `mue-preview-alpha-start.ts` | [Platform proposal](../../../docs/BPM-PLATFORM-PROPOSAL.md) and [MUE Preview Alpha proposal](../../../docs/MUE-PREVIEW-ALPHA-PROPOSAL.md) |
