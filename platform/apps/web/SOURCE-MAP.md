...
| Definition triggers | `definition-schedule-*`, `message-start-publication-*`, `correlated-message-*`, `definition-workspace.tsx` | [Message key-correlation specification](../../../docs/capsules/MESSAGE-KEY-CORRELATION-SPEC.md), the applicable semantic specifications, and the [UI design specification](../../../docs/BPM-PLATFORM-UI-DESIGN-SPEC.md) |
...
| Process search, committed execution, and conditional MUE Alpha progress | `deferred-operations-workspace.tsx`, `process-instance-search-panel.tsx`, `process-execution-api.ts`, `process-instance-execution-detail.tsx`, `mue-preview-alpha-progress.tsx` | [Process-instance search specification](../../../docs/BPM-PLATFORM-PROCESS-INSTANCE-SEARCH-SPEC.md), [committed-execution publication specification](../../../docs/capsules/COMMITTED-EXECUTION-PUBLICATION-SPEC.md), and [MUE Preview Alpha specification](../../../docs/MUE-PREVIEW-ALPHA-SPEC.md) |
