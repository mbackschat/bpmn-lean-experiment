...
|---|---|---|
| Application shell and navigation | `app.tsx`, `workspace-shell.tsx`, `workspace-navigation.tsx` | [UI design specification](../../../docs/BPM-PLATFORM-UI-DESIGN-SPEC.md) |
...
| Process operator history and canonical audit download | `operator-audit-api.ts`, `process-operator-history.tsx`, `process-instance-execution-detail.tsx` | [Operator history and audit export proposal](../../../docs/BPM-PLATFORM-OPERATOR-HISTORY-AUDIT-EXPORT-PROPOSAL.md) |
