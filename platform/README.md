...
Directories here are ownership boundaries, not deployment-service claims. A directory may exist as a tracked scaffold while its production behavior remains absent.
