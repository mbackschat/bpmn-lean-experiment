...
const consumers = [
  ...
  { source: "a12-create-document-source.ts", anchor: "projectPlainNode", elementName: "value", shape: "PlainNode" },
  { source: "a12-create-document-source.ts", anchor: "projectCreateDocument", elementName: "value", shape: "A12CreateServiceTask" },
  { source: "a12-create-document-source.ts", anchor: "projectFlows", elementName: "flow", shape: "A12CreateSequenceFlow" },
  { source: "a12-boundary-error-source.ts", anchor: "projectServiceTask", elementName: "value", shape: "A12BoundaryServiceTask" },
  { source: "a12-boundary-error-source.ts", anchor: "projectBoundaryRoute", elementName: "boundary", shape: "A12BoundaryEvent" },
  { source: "a12-boundary-error-source.ts", anchor: "projectPlainNode", elementName: "value", shape: "A12BoundaryIdentityNode" },
  { source: "a12-boundary-error-source.ts", anchor: "projectUserTask", elementName: "value", shape: "PlainNode" },
  { source: "a12-boundary-error-source.ts", anchor: "projectFlows", elementName: "flow", shape: "A12BoundarySequenceFlow" },
...
const inventoryCases = [
  ["genericShapes", "startEventType", ["PlainNode"]],
  ...
  ["a12CreateShapes", "startEventType", ["PlainNode"]],
  ["a12CreateShapes", "endEventType", ["PlainNode"]],
  ["a12CreateShapes", "serviceTaskType", ["A12CreateServiceTask"]],
  ["a12CreateShapes", "sequenceFlowType", ["A12CreateSequenceFlow"]],
  ["a12BoundaryShapes", "startEventType", ["A12BoundaryIdentityNode"]],
  ["a12BoundaryShapes", "endEventType", ["A12BoundaryIdentityNode"]],
  ["a12BoundaryShapes", "userTaskType", ["PlainNode"]],
  ["a12BoundaryShapes", "serviceTaskType", ["A12BoundaryServiceTask"]],
  ["a12BoundaryShapes", "boundaryEventType", ["A12BoundaryEvent"]],
  ["a12BoundaryShapes", "sequenceFlowType", ["A12BoundarySequenceFlow"]],
...
function assertInventoryOwnership(files: ReadonlyMap<string, SourceFile>): void {
  ...
  assert.deepEqual(profileDispatch(file), {
    ...
    A12CreateDocument: "a12CreateShapes",
    A12BoundaryError: "a12BoundaryShapes",
