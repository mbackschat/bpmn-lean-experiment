...
The [BPMN fixture](process.bpmn) is project-authored MIT-licensed source under the distinct `cibseven-2.0.0-a12-boundary-error-draft` profile. It is not a copy of any EUPL-1.2 A12 model.
