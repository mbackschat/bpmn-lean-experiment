...
BPMN 2.0.2 Clauses 10.5.6, 13.2, 13.3.4, and 13.5.6 plus Table 12.22 are the normative authority. The exact selected source, containing-scope account, proofs, hosting boundary, evidence, and exclusions belong to the [Terminate End Event specification](../../docs/capsules/TERMINATE-END-EVENT-SPEC.md).
