...
The exact QName admission, semantic instance identity, return rule, finite evidence, and exclusions belong to the [Call Activity specification](../../docs/capsules/CALL-ACTIVITY-SPEC.md). Status remains `draft`; this profile makes no general Call Activity, recursive-call, data-mapping, Child Workflow, A12 adoption, BPMN Process Execution Conformance, or production-history claim.
