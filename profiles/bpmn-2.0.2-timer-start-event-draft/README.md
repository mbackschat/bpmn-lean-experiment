...
BPMN 2.0.2 is the normative authority. The exact selected meaning, forward-compatible admission restriction, resolved-occurrence boundary, host refinement, and exclusions are owned by the [Timer Start Event specification](../../docs/capsules/TIMER-START-EVENT-SPEC.md).
