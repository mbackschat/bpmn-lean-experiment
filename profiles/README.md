...
- [BPMN 2.0.2 Activity data-input/output User Task draft](bpmn-2.0.2-activity-data-input-output-user-task-draft/README.md)
...
- [BPMN 2.0.2 repeatable Event subscriptions draft](bpmn-2.0.2-repeatable-event-subscriptions-draft/README.md)
...
The [BPMN 2.0.2 Message key correlation draft profile](bpmn-2.0.2-message-key-correlation-draft/README.md) selects one context-backed, single-property String key and definition-scoped exact-cardinality publication. Equal model-local ids in another source definition remain isolated by complete semantic-definition identity, and `CIB-LIM-0002` records why no CIB correlation target is selected.
