...
The exact meaning, evidence boundary, and exclusions are owned by the [Exclusive Gateway conditional routing proposal](../../docs/capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md). Status remains `draft`; the profile makes no general expression-language, Exclusive Gateway, CIB JUEL, A12 adoption, or BPMN Process Execution Conformance claim.
