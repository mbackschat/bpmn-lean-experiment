...
BPMN 2.0.2 is the normative authority. The exact selected meaning, forward-compatible admission restriction, proof obligations, and exclusions are owned by the [cyclic-control-flow specification](../../docs/capsules/CYCLIC-CONTROL-FLOW-SPEC.md).
