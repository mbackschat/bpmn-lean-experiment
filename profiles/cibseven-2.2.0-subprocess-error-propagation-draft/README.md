...
The profile reuses `CIB-AGR-0001`, `CIB-AGR-0002`, and `CIB-OP-0001` only for Process lifecycle, active User Task discovery/completion, and host-task mapping to exact semantic occurrences. The governing boundaries are in the [Error propagation capsule](../../docs/capsules/SUBPROCESS-ERROR-PROPAGATION-SPEC.md) and [CIB–BPMN relationship register](../../docs/CIB-BPMN-RELATION-REGISTER.md).
