...
BPMN 2.0.2 Clauses 7.7, 8.3.3, 10.3, 10.3.3.1, 13.3.2, and 13.3.3 plus Table 10.4 are the normative authority. The exact extension source, distinction from plain Abstract Task, profile binding, evidence, and exclusions belong to the [configured generic Task proposal](../../docs/capsules/CONFIGURED-GENERIC-TASK-PROPOSAL.md).
