...
The governing interpretation and evidence boundaries are in the [User Task discovery and completion capsule](../../docs/USER-TASK-DISCOVERY-COMPLETION-CAPSULE.md).
