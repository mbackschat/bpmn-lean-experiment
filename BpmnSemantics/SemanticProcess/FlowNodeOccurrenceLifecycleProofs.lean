...
/-! # Flow-node occurrence lifecycle assurance laws

This module owns the quantified fold-soundness and cancellation-preservation laws for flow-node occurrence lifecycle deltas. Concrete executable witnesses remain in the conformance module.
-/
...
private theorem contains_ended_anchor_iff (ended : List UnnumberedFlowNodeOccurrenceEnd)
