...
/-! # Checked-process and Semantic Process JSON admission

This module owns strict current-shape decoding for both definition representations and the semantic-element decoders they share. Scenario and cross-artifact input admission remain separate.
-/
