...
| [Intermediate Catch Message](INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md) | Owner-review proposal for one directly addressed, payload-free Intermediate Catch Message subscription, exact one-consumption and stale refusal, public resumption surface, and durable Signal/replay boundary; throw, Message Flow, key correlation, and CIB message compatibility remain excluded |
