...
| [Service Task effect](SERVICE-TASK-EFFECT-PROPOSAL.md) | Unapproved success-only proposal for one extension-bound Service Task, blocked as decision-ready on the prior [CIB Seven compatibility-scope decision](../CIB-SEVEN-COMPATIBILITY-SCOPE-PROPOSAL.md) |
