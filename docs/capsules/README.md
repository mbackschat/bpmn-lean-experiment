...
| [Embedded Sub-Process Error propagation](SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md) | Owner-approved proposal for exact-code Error End propagation, direct interrupting handling, regional cancellation with monotonic counter preservation, unreachable normal continuation, outer recovery, post-throw Worker replacement, and the selected CIB Seven `2.2.0` phase-zero/agreement lane; implementation has not started |
