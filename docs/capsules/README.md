...
| [Exclusive Gateway conditional routing](EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md) | Owner-approved, unimplemented two-condition-plus-default routing capsule with XML Sequence Flow declaration order, pinned read-only CIB JUEL evaluation, content-bound receipt, rollback, and Java Activity preflight |
