...
| [CreateDocument data and mapping](CREATE-DOCUMENT-DATA-PROPOSAL.md) | Owner-approved A12 target capsule for one string literal input, Activity-local result patch, output mapping, Process-variable projection, and success-only CIB/Temporal transaction classification; implementation pending |
