...
| [Exclusive Gateway conditional routing](EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md) | Owner-approved, unimplemented two-condition-plus-default routing capsule with strict condition admission, XML Sequence Flow declaration order, pinned read-only CIB JUEL evaluation, short-lived validation Workflow, private suspension, content-bound receipt, rollback, exhaustion recovery, and Java Activity preflight |
