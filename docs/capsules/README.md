...
| [Embedded Sub-Process Error propagation](SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md) | Rebased owner-review proposal for exact-code Error End propagation, direct interrupting handling, regional cancellation of a live sibling User Task, unreachable normal continuation, outer recovery, and an optional CIB Seven `2.2.0` public-agreement lane; implementation remains unauthorized |
