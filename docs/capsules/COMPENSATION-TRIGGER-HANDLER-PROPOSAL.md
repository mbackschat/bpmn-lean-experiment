...
| [TS evaluator](../../packages/semantic-core/src/semantic-process-runtime.ts) | 35 | dispatch only; trigger, handler, and Activity-data logic stay extracted before growth |
