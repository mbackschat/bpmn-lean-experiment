...
| [Lean observation consumer](../../BpmnSemantics/SemanticProcess/Scenario.lean) | 226 | failed projection and agreement only |
...
Public pipeline evidence must still route admitted snapshot Programs through the selected snapshot-aware Lean account and compare complete execution and publication with TypeScript. The ordinary [scenario JSON runner](../../BpmnSemantics/SemanticProcessJsonMain.lean) and [publication runner](../../BpmnSemantics/SemanticProcessJson/Publication.lean) do not currently establish that correspondence. Registration, corpus, Product 2, and broader Compensation or Transaction admission remain separate prerequisites; ordinary snapshot batching alone does not close them.
