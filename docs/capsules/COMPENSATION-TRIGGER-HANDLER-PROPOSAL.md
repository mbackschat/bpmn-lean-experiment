...
The [public registration amendment](#public-registration-amendment) awaits independent proposal review before its implementation. Earlier approved semantic and hosting checkpoints retain their recorded boundaries.
...
The public registration proposal received a context-cold review at `f24977b2a0917299dcedcf6923ec59afb1fc6719`, against baseline `dbc1f77f91491d077dd1c4c87f28cd8fcf26c2f2`, on 2026-09-24. Isolation: `fork-turns-none`; verdict: `approve-with-required-edits`; correction audit: pending. Packet SHA-256: `928f40271feffb3e3bd288dd8b03a216248c4e17ca3a2e27c0d5846acdd0decc`. The reviewer passed 27 documentation checks and verified all supplied hashes and source provenance. Finding R1 requires naming the actual normative-artifact guard rather than the CIB-only projection suite; the corrected link and description above address it without changing scope or the evidence strategy. Registration implementation waits for the same reviewer’s correction audit.
