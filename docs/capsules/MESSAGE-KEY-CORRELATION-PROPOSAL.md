...
| [Temporal protocol index](../../packages/temporal-adapter/protocol/src/index.ts) | 772 | export one new bounded protocol owner only |
| [Temporal client index](../../packages/temporal-adapter/client/src/index.ts) | 791 | export one new bounded client owner only |
| [Temporal Workflow index](../../packages/temporal-adapter/workflow/src/index.ts) | 760 | export the new ingress Workflow and Process-candidate Query owner only |
| [Temporal Worker index](../../packages/temporal-adapter/worker/src/index.ts) | 795 | export one bounded correlation-Activity owner only |
| [Temporal Worker runtime](../../packages/temporal-adapter/worker/src/external-temporal-runtime.ts) | 614 | compose the private WorkflowClient-backed Activities; Activity logic belongs in the new owner |
