...
| [Temporal protocol index](../../packages/temporal-adapter/protocol/src/index.ts) | 771 | export one new bounded protocol owner only |
| [Temporal client index](../../packages/temporal-adapter/client/src/index.ts) | 791 | export one new bounded client owner only |
| [Temporal Workflow index](../../packages/temporal-adapter/workflow/src/index.ts) | 758 | export the new ingress Workflow and Process-candidate Query owner only |
