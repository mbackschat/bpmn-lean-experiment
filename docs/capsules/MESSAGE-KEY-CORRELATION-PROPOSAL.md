...
| [Lean Transition](../../BpmnSemantics/SemanticProcess/Transition.lean) | 29 | add one dispatcher constructor; matcher and laws belong in new modules |
...
| [Lean internal-commutation census](../../BpmnSemantics/SemanticProcess/InternalCommutationCensus.lean) | 661 | add the matching exhaustive constructor classification only |
