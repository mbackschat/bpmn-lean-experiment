...
| [Lean SemanticProcessContract](../../BpmnSemantics/SemanticProcessContract.lean) | 106 | add only closed contract arms; extract correlation support types first if the edit would cross 800 |
...
| [TypeScript internal-commutation census](../../packages/semantic-core/src/internal-commutation-census.ts) | 668 | add the exact ordinary-wait classification only; footprint logic belongs in the correlated family owner |
| [Lean internal-commutation census](../../BpmnSemantics/SemanticProcess/InternalCommutationCensus.lean) | 664 | add the matching exhaustive constructor classification only |
