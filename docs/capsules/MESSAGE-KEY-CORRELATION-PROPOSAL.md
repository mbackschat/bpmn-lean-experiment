...
| [TypeScript semantic runtime dispatch](../../packages/semantic-core/src/semantic-process-runtime.ts) | 60 | add dispatch only; correlation behavior belongs in a new family owner |
...
| [Lean Transition](../../BpmnSemantics/SemanticProcess/Transition.lean) | 20 | add one dispatcher constructor; matcher and laws belong in new modules |
...
| [TypeScript internal-commutation census](../../packages/semantic-core/src/internal-commutation-census.ts) | 663 | add the exact ordinary-wait classification only; footprint logic belongs in the correlated family owner |
| [Lean internal-commutation census](../../BpmnSemantics/SemanticProcess/InternalCommutationCensus.lean) | 659 | add the matching exhaustive constructor classification only |
