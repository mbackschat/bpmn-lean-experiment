...
| [Temporal Workflow index](../../packages/temporal-adapter/workflow/src/index.ts) | 757 | export the new ingress Workflow and Process-candidate Query owner only |
