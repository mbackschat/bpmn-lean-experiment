...
Evidence: [the Activity data-output semantic owner](../../BpmnSemantics/SemanticProcess/ActivityDataOutput.lean) proves this bounded transition family's data-independent activation, association-routed write, atomic cleanup, and refusal laws, while [the conformance module](../../BpmnSemantics/ActivityDataOutputConformance.lean) checks the fixed routed-write and refusal witnesses; the claim does not extend to a general Activity data interface.
