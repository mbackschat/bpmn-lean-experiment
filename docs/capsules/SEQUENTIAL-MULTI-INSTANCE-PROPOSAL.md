...
The proved `finite_snapshot_conditional_progress_eventually_closes` theorem uses the finite remaining-item measure. Each accepted family event either removes the target controller or strictly decreases that measure. Its progress hypothesis is explicit, so it supplies no human-completion or Timer-delivery fairness and does not turn conditional closure into unconditional liveness.
...
| [exact controller binding](../../packages/semantic-core/src/sequential-multi-instance-binding.ts) | 509 |
...
| [Lean laws](../../BpmnSemantics/SemanticProcess/SequentialMultiInstanceLaws.lean) | 239 |
| [Lean fixtures](../../BpmnSemantics/SequentialMultiInstanceConformance.lean) | 176 |
| [progress projection](../../packages/semantic-core/src/sequential-multi-instance-observation.ts) | 456 |
