...
| Lean library reachability | [Maintained Lean library root](../../BpmnSemantics.lean) | Change: import the new conformance module so the derived maintained-conformance guard reaches it. |
