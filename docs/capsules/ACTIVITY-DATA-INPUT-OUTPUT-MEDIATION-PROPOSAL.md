...
| Internal scheduling | [TypeScript internal census](../../packages/semantic-core/src/internal-commutation-census.ts), [wait census](../../packages/semantic-core/src/internal-transition-wait-census.ts), [footprint](../../packages/semantic-core/src/internal-transition-footprint.ts), and [Lean internal census](../../BpmnSemantics/SemanticProcess/InternalCommutationCensus.lean) | Change: register `compositeWaitAndActivityArming`, retain unavailable footprint, and fail closed until the next RC unit supplies the reviewed footprint. |
...
| Activity writer, artifact, and executable-corpus registries | [Activity writer records](../../scripts/activity-occurrence-writer-records.ts), [contract artifact cases](../../scripts/contract-artifact-cases.ts), [capability extractor](../../scripts/executable-model-capabilities.ts), and [capability catalog](../../model-corpus/mvp-capabilities.ts) | Change: register the composed writers at the semantic checkpoint and the scenarios plus retained whole-model capability at closure. |
| Activity body-claim uniqueness proof | [Shared predecessor preservation owner](../../BpmnSemantics/SemanticProcess/ActivityBodyClaimWriterPreservation.lean) | No change: the composed issuer's `activityBodyClaimsUnique` theorem belongs in planned `BpmnSemantics/SemanticProcess/ActivityDataInputOutput.lean`, and its writer record must cite that theorem there. |
...
Headroom is measured as nonblank lines remaining under the 800-line review target before proposal implementation. The three mandatory extractions are semantic obligations, not formatting exercises: extract the direct Activity-data Lean carriers before growing the 5-line contract margin, the TypeScript Activity-data validators before growing the 15-line admission margin, and Activity-data runtime dispatch before growing the 18-line dispatcher margin. Other owners may be extracted if the actual change cannot stay reviewable within the recorded margin.
