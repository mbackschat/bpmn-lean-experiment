...
| [Lean bounded scope](../../BpmnSemantics/SemanticProcess/BoundedScope.lean) | 457 | **Created by this change** as the narrow module beside `BoundedTask.lean` that the `Execution.lean` row promised. Carries arming and the deadline arm today; the victory relation and the remaining laws land here. |
