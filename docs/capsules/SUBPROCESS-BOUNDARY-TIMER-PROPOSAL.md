...
**Owner-approved on 2026-08-04; closure review closed, graduation pending.** All four decisions below are approved as recommended. The owner delegated the decision in this session rather than ruling on each one individually, so the approval rests on the recommendations and rationales recorded here and on the closed proposal review; it is not an independent owner analysis of the four alternatives. Approval authorizes exactly the scope recorded in this document and nothing beyond it.
