...
| [`flow-node-occurrence-lifecycle.ts`](../../packages/semantic-core/src/flow-node-occurrence-lifecycle.ts) | 107 | add the host-task and triggered Boundary Event lifecycle; extract first only if the edit would cross 800 |
| [`flow-node-occurrence-publication-completeness.ts`](../../packages/semantic-core/src/flow-node-occurrence-publication-completeness.ts) | 263 | add the new operation to complete E1/E2 publication census; extract first only if the edit would cross 800 |
