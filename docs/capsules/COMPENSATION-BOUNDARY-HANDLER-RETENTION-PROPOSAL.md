...
| [TypeScript well-formedness](../../packages/semantic-core/src/runtime-state-well-formedness.ts) | 53 | add one delegated validator hook; extract before crossing 800 |
...
| [TypeScript command admission](../../packages/semantic-core/src/semantic-command-admission.ts) | 330 | no producer integration at the first checkpoint |
...
| [Lean well-formedness](../../BpmnSemantics/SemanticProcess/RuntimeStateWellFormed.lean) | 94 | add one delegated predicate; extract before crossing 800 |
...
| [Lean Activity-body turnover preservation](../../BpmnSemantics/SemanticProcess/ActivityBodyTurnoverPreservation.lean) | 588 | preserve compensation validity and destructure lifecycle facts by name rather than positional projection |
