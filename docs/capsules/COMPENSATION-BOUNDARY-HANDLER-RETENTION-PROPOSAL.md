...
| [Lean scope completion](../../BpmnSemantics/SemanticProcess/ScopeCompletion.lean) | 681 | add exact register disposal and update its frame theorem |
...
| [Lean message-key correlation preservation](../../BpmnSemantics/SemanticProcess/MessageKeyCorrelationPreservation.lean) | 353 | reconstruct the strengthened aggregate invariant while framing the compensation register exactly |
