...
| [Lean parallel Multi-Instance closing progress preservation](../../BpmnSemantics/SemanticProcess/ParallelMultiInstanceRuntimeStateClosingProgressPreservation.lean) | 233 | frame the compensation register through non-terminal closing progress |
| [Lean parallel Multi-Instance closing terminal preservation](../../BpmnSemantics/SemanticProcess/ParallelMultiInstanceRuntimeStateClosingTerminalPreservation.lean) | 13 | frame the compensation register through terminal child closing; any further growth should extract the frame proof |
