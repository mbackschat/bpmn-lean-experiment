...
| [Lean command admission](../../BpmnSemantics/SemanticProcess/CommandAdmission.lean) | 221 | predicate definition and one dispatch branch only |
...
| [Product 1 source witness](../../packages/temporal-adapter/testkit/test/compensation-source-host-refusal.test.ts) | 458 | exact assessment/start and malformed, rewired, or over-cap pre-start cases only |
