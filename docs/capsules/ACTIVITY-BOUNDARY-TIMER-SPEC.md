...
No new runtime collection was proposed *by this capsule*, and one was added later. The existing task and timer wait families already carry complete occurrence identity, and this capsule's operation supplied the ownership relation that the Event-Based Gateway needed a hidden record for.
