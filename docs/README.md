...
| [SEMANTIC-PROCESS-IL-PROPOSAL.md](SEMANTIC-PROCESS-IL-PROPOSAL.md) | Semantic, source, and adapter contributors; owner-approved but unimplemented checked BPMN graph and bounded Semantic Process IL proposal, including lowering rules, operational semantics, Lean proof obligations, growth policy, and stop criteria |
