...
| Understand the Intermediate Catch Timer design | [Intermediate Catch Timer proposal](capsules/INTERMEDIATE-CATCH-TIMER-PROPOSAL.md), [TEMPORAL-EXECUTION-RESEARCH.md](TEMPORAL-EXECUTION-RESEARCH.md), and [Semantic Process IL specification](SEMANTIC-PROCESS-IL-SPEC.md) |
...
| [capsules/INTERMEDIATE-CATCH-TIMER-PROPOSAL.md](capsules/INTERMEDIATE-CATCH-TIMER-PROPOSAL.md) | Owner and semantic contributors; exact `PT1S` Intermediate Catch Timer meaning, source/IL/runtime contract, controlled-clock CIB probe, and Temporal durable-wakeup preflight |
