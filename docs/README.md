...
| [capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md](capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md) | Owner and semantic contributors; approved but unimplemented bounded divergent Exclusive Gateway rules, read-only CIB JUEL profile, content-bound receipt, rollback, targeted preservation gates, and Temporal Java Activity preflight |
| [JUEL-EVALUATION-ARCHITECTURE-DECISION.md](JUEL-EVALUATION-ARCHITECTURE-DECISION.md) | Owner, semantic, compatibility, and adapter contributors; selected actual-JUEL evaluator boundary, complete-context rule, read-only capability boundary, Temporal Java Activity direction, evidence limits, and implementation prerequisites |
