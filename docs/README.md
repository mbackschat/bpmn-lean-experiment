...
| Select or review embedded Sub-Process work | [Ordinary embedded Sub-Process completion specification](capsules/EMBEDDED-SUBPROCESS-COMPLETION-SPEC.md), [CIB Seven breadth research](research/CIB-SEVEN-BPMN-BREADTH-RESEARCH.md), [Error propagation follow-on](capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md), [BPMN requirement ledger](BPMN-REQUIREMENT-LEDGER.md), and [PLAN.md](PLAN.md) |
...
| [capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md](capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md) | Owner and semantic contributors; retained exceptional-exit follow-on whose exact-code Error propagation, regional cancellation, and versioning account must rebase on the ordinary-scope foundation |
