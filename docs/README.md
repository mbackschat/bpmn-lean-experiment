...
| Review the proposed Service Task effect account | [CIB Seven compatibility scope proposal](CIB-SEVEN-COMPATIBILITY-SCOPE-PROPOSAL.md), [Service Task effect proposal](capsules/SERVICE-TASK-EFFECT-PROPOSAL.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
...
| [capsules/SERVICE-TASK-EFFECT-PROPOSAL.md](capsules/SERVICE-TASK-EFFECT-PROPOSAL.md) | Owner and semantic contributors; exact-source, effect-intent, idempotency, CIB retry, Temporal Activity, reconciliation, and evidence account for one Service Task |
