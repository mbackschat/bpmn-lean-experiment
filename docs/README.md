...
| Implement or review Intermediate Catch Timer behavior | [Intermediate Catch Timer spec](capsules/INTERMEDIATE-CATCH-TIMER-SPEC.md), [TEMPORAL-EXECUTION-RESEARCH.md](TEMPORAL-EXECUTION-RESEARCH.md), and [Semantic Process IL specification](SEMANTIC-PROCESS-IL-SPEC.md) |
