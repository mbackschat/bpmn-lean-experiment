...
| [capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md](capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md) | Owner and semantic reviewers; revised unimplemented proposal for profile-multiset/generic-graph Message admission, direct payload-free subscription delivery, Signal result recovery, canonical wait-order reopening, and exact Signal/replay evidence |
