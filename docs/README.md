...
| [capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md](capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md) | Owner and semantic reviewers; unimplemented proposal for a directly addressed, payload-free Intermediate Catch Message subscription, exact occurrence/channel matching, one-consumption and stale refusal, and durable Signal/replay preflight |
