...
| Review the proposed Intermediate Catch Message boundary | [Intermediate Catch Message proposal](capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md), [BPMN requirement ledger](BPMN-REQUIREMENT-LEDGER.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
...
| [capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md](capsules/INTERMEDIATE-CATCH-MESSAGE-PROPOSAL.md) | Owner and semantic contributors; approved unimplemented proposal for profile-multiset/generic-graph Message admission, direct payload-free subscription delivery, Signal result recovery, canonical wait-order reopening, and exact Signal/replay evidence |
