...
| Implement or review the runnable external-Temporal MVP | [Runnable Temporal MVP proposal](RUNNABLE-TEMPORAL-MVP-PROPOSAL.md), [Process-start data specification](capsules/PROCESS-START-DATA-SPEC.md), [User Task completion-data specification](capsules/USER-TASK-COMPLETION-DATA-SPEC.md), [production lifecycle specification](TEMPORAL-PROCESS-LIFECYCLE-SPEC.md), and [PLAN.md](PLAN.md) |
...
| Select or review the first embedded Sub-Process and Error-propagation capsule | [Embedded Sub-Process Error propagation proposal](capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md), [BPMN requirement ledger](BPMN-REQUIREMENT-LEDGER.md), [Semantic Process IL specification](SEMANTIC-PROCESS-IL-SPEC.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
...
| [RUNNABLE-TEMPORAL-MVP-PROPOSAL.md](RUNNABLE-TEMPORAL-MVP-PROPOSAL.md) | Product owner and adapter contributors; owner-approved external-Temporal runtime, documented bounded subset, dummy actor around a durable User Task wait, simulated form-input contract, acceptance criteria, and exclusions |
...
| [capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md](capsules/SUBPROCESS-ERROR-PROPAGATION-PROPOSAL.md) | Owner and semantic contributors; selected error-only one-level embedded Sub-Process, direct-parent exact-code Error propagation, regional child-scope cancellation, outer recovery, Temporal preflight, evidence boundary, and explicit normal-completion exclusion |
