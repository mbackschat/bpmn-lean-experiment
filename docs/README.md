...
| [capsules/EMBEDDED-SUBPROCESS-COMPLETION-PROPOSAL.md](capsules/EMBEDDED-SUBPROCESS-COMPLETION-PROPOSAL.md) | Owner and semantic contributors; selected ordinary one-level embedded Sub-Process entry, child ownership, independent child End consumption, quiescent completion, parent continuation, Temporal preflight, and evidence boundary |
