...
| [capsules/PARALLEL-FORK-JOIN-PROPOSAL.md](capsules/PARALLEL-FORK-JOIN-PROPOSAL.md) | Owner and semantic contributors; approved but unimplemented observable-contract proposal, rules and witnesses, candidate CIB deviation, representation decision, prerequisites, and exclusions for the next parallel slice |
