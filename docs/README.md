...
| Implement or review the runnable external-Temporal MVP | [Runnable Temporal MVP proposal](RUNNABLE-TEMPORAL-MVP-PROPOSAL.md), [User Task completion-data proposal](capsules/USER-TASK-COMPLETION-DATA-PROPOSAL.md), [production lifecycle specification](TEMPORAL-PROCESS-LIFECYCLE-SPEC.md), and [PLAN.md](PLAN.md) |
...
| [capsules/USER-TASK-COMPLETION-DATA-PROPOSAL.md](capsules/USER-TASK-COMPLETION-DATA-PROPOSAL.md) | Owner, semantic, CIB, and adapter contributors; approved unimplemented exact User Task string/null completion patch, required `2.2.0` probe, atomic contract replacement, Temporal preflight, and exclusions |
