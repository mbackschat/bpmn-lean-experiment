...
| Implement or review the runnable external-Temporal MVP | [Runnable Temporal MVP proposal](RUNNABLE-TEMPORAL-MVP-PROPOSAL.md), [User Task completion-data specification](capsules/USER-TASK-COMPLETION-DATA-SPEC.md), [production lifecycle specification](TEMPORAL-PROCESS-LIFECYCLE-SPEC.md), and [PLAN.md](PLAN.md) |
