...
| Review compositional BPMN source admission and lowering | [Compositional BPMN admission proposal](COMPOSITIONAL-BPMN-ADMISSION-PROPOSAL.md), [BPMN requirement ledger](BPMN-REQUIREMENT-LEDGER.md), [Semantic Process IL specification](SEMANTIC-PROCESS-IL-SPEC.md), and [checked-source experiment](experiments/CHECKED-SOURCE-RELATION-EXPERIMENT.md) |
...
| Implement or review expression evaluation | [Simple Boolean expression decision](SIMPLE-BOOLEAN-EXPRESSION-DECISION.md), [Exclusive Gateway condition proposal](capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md), [deferred JUEL architecture decision](JUEL-EVALUATION-ARCHITECTURE-DECISION.md), [CIB–BPMN relationship register](CIB-BPMN-RELATION-REGISTER.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
...
| [capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md](capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md) | Owner and semantic contributors; approved but unimplemented bounded divergent Exclusive Gateway rules, explicit Simple Boolean language profile, strict source admission, typed `choose` lowering, pure internal closure, targeted preservation gates, and Temporal replay preflight |
