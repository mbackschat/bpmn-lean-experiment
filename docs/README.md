...
| Decide or review JUEL expression evaluation | [JUEL evaluation architecture decision](JUEL-EVALUATION-ARCHITECTURE-DECISION.md), [Exclusive Gateway condition proposal](capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md), [CIB Seven extension research](research/CIB-SEVEN-EXTENSIONS-RESEARCH.md), [CIB–BPMN relationship register](CIB-BPMN-RELATION-REGISTER.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
...
| [capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md](capsules/EXCLUSIVE-GATEWAY-CONDITION-PROPOSAL.md) | Owner and semantic contributors; approved but unimplemented bounded divergent Exclusive Gateway rules, strict source profile, read-only CIB JUEL, validation Workflow, private suspension, content-bound receipt, rollback/exhaustion handling, targeted preservation gates, and Temporal Java Activity preflight |
| [JUEL-EVALUATION-ARCHITECTURE-DECISION.md](JUEL-EVALUATION-ARCHITECTURE-DECISION.md) | Owner, semantic, compatibility, and adapter contributors; selected actual-JUEL evaluator boundary, tagged complete-context rule, read-only capability boundary, validation/runtime Temporal Java Activity direction, evidence limits, and implementation prerequisites |
