...
| [capsules/CREATE-DOCUMENT-DATA-PROPOSAL.md](capsules/CREATE-DOCUMENT-DATA-PROPOSAL.md) | Owner and semantic contributors; proposed A12 `CreateDocument` string-variable, mapping, effect-patch, unchanged-source, and success-only transaction-refinement contract |
