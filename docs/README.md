...
| Implement or review the Semantic Process IL and parallel fork/join proposals | [SEMANTIC-PROCESS-IL-PROPOSAL.md](SEMANTIC-PROCESS-IL-PROPOSAL.md), [parallel fork/join proposal](capsules/PARALLEL-FORK-JOIN-PROPOSAL.md), [CIB-BPMN-RELATION-REGISTER.md](CIB-BPMN-RELATION-REGISTER.md), and [PLAN.md](PLAN.md) |
...
| [SEMANTIC-PROCESS-IL-PROPOSAL.md](SEMANTIC-PROCESS-IL-PROPOSAL.md) | Semantic, source, and adapter contributors; owner-approved, partially implemented checked BPMN graph and bounded Semantic Process IL proposal, including lowering rules, operational semantics, Lean proof obligations, growth policy, and remaining graduation criteria |
...
| [capsules/PARALLEL-FORK-JOIN-PROPOSAL.md](capsules/PARALLEL-FORK-JOIN-PROPOSAL.md) | Owner and semantic contributors; approved and partially implemented observable-contract proposal, Lean and TypeScript rules and witnesses, candidate CIB deviation, representation decision, remaining evidence prerequisites, and exclusions for the parallel slice |
