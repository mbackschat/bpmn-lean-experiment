...
| Decide or review JUEL expression evaluation | [JUEL evaluation architecture decision](JUEL-EVALUATION-ARCHITECTURE-DECISION.md), [CIB Seven extension research](research/CIB-SEVEN-EXTENSIONS-RESEARCH.md), [CIB–BPMN relationship register](CIB-BPMN-RELATION-REGISTER.md), [TEMPORAL-EXECUTION-RESEARCH.md](research/TEMPORAL-EXECUTION-RESEARCH.md), and [PLAN.md](PLAN.md) |
