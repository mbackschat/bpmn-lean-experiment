...
- three exact Activity data-input schedules across Lean, the core, and Temporal with CIB semantic execution absent, separating a present string, an explicit null, and an absent source, plus source-ownership, association-direction, copy-target, local-owner, disposal, completion-domain, and public-input-collection mutation discriminators
- three exact Activity data-output schedules across Lean, the core, and Temporal with CIB semantic execution absent, separating a supplied string, a supplied explicit null, and an omitted required output, plus routed-versus-named-write, association-direction, cardinality, refusal-preservation, disposal, and empty-input-collection mutation discriminators
