...
- `@bpmn-lean/platform-operate` and `@bpmn-lean/platform-work`, whose cross-backend adapters share repository contracts, Unicode identity, terminal closure, race serialization, suffix-only projections, coherent snapshots, and contiguous audit-source ordinals
