...
- Line-by-line exhaustive Process Execution denominator, arbitrary compositional graph admission, broad Activity/Event/Gateway/scope/data coverage, percentage-complete claim, or conformance claim
