...
| Scenarios and observations | Neutral protocol requirements retained in the handoff; artifact policy in [scenarios/README.md](../scenarios/README.md) | Scenario schema, BPMN cases, canonical observation schema, comparator, traces, regressions |
