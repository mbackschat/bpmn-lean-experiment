...
**Two products, five platform showcase floors closed.** The engine executes the bounded slice owned by twenty-two closed capsules. The [BPM platform](BPM-PLATFORM-PROPOSAL.md) has closed M1 through M5.
