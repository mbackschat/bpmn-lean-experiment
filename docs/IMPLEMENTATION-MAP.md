...
The owner-approved [flow-node occurrence metrics increment](capsules/FLOW-NODE-OCCURRENCE-METRICS-PROPOSAL.md) is implemented through Lean/core lifecycle parity, E1-aligned publication and replay-stable batch time, live Product 1 replay evidence, exact-version all-or-unavailable Product 2 projection, frequency/completed-duration aggregation, HTTP, and a two-width bpmn-js/table UI. Closure review remains pending.
