...
- forced Message/Timer/effect rollover evidence and deployment admission beyond the implemented recovery-ledger boundary, production chain, cyclic User Task witnesses, paired publication traversal, Query-response capacity, terminal-result capacity, Event History capacity, aggregate continuation capacity, and 128-Run capacity;
