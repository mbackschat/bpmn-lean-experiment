...
- forced Timer/effect rollover evidence beyond the implemented recovery-ledger boundary, production chain, cyclic User Task and Message witnesses, paired publication traversal, Query-response capacity, terminal-result capacity, Event History capacity, aggregate continuation capacity, 128-Run capacity, and stop-the-world deployment admission;
