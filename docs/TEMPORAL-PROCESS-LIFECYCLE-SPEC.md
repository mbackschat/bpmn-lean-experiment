...
- forced Message/Timer/effect rollover evidence, deployment admission, and the approved Run capacity row beyond the implemented recovery-ledger boundary, production chain, cyclic User Task witnesses, paired publication traversal, Query-response capacity, terminal-result capacity, Event History capacity, and aggregate continuation capacity;
