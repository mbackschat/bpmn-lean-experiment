...
- forced Message/Timer/effect rollover evidence, deployment admission, and the approved capacity rows beyond the implemented recovery-ledger boundary, production chain, cyclic User Task witness, paired publication traversal, and Query-response capacity;
