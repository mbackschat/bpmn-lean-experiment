...
- forced Message/Timer/effect rollover evidence, deployment admission, and the approved aggregate and Run capacity rows beyond the implemented recovery-ledger boundary, production chain, cyclic User Task witnesses, paired publication traversal, Query-response capacity, terminal-result capacity, and Event History capacity;
