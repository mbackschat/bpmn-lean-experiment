...
- host cancellation, termination, timeout, reset, pause, failure, and operator-repair semantics; semantic interruption remains limited to the separately specified direct-parent Error and exact nested Terminate slices and never uses those host mechanisms;
