...
This detail map owns exact current Product 1 protocol, client, Workflow, Worker, runner, testkit, replay, durable-hosting, and Workflow-chain capacity status. Root routing and cross-area claims remain in [IMPLEMENTATION-MAP.md](IMPLEMENTATION-MAP.md).
