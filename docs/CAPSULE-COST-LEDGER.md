...
| [Lean comment discipline](LEAN-COMMENT-DISCIPLINE-PROPOSAL.md) | `cc1ae8f..6f3d3d7` | `+1586/-1116` | `+21/-8` | Unknown | About one quarter of the code additions in the nearest source-ownership hygiene increment (`9f1f046..7674a02`, `+6210/-5144` code and `+18/-6` documentation). Most churn is ownership-preserving Lean extraction plus the focused scanner and tests; the selected comment backfill remains small and no density target is inferred from either measurement. |
