...
Implementation updates the Product 2 web catalog, About panel and CSS, component and browser tests, root release graph, feedback-efficiency guard, [web source map](../platform/apps/web/SOURCE-MAP.md), [web guide](../platform/apps/web/README.md), [showcase registry](../showcase/README.md), [testing specification](TESTING-SPEC.md), [`implementation-status-owner:BPM-PLATFORM`](BPM-PLATFORM-IMPLEMENTATION-MAP.md), [`implementation-status-owner:ASSURANCE-ADOPTION`](ASSURANCE-AND-ADOPTION-IMPLEMENTATION-MAP.md), [documentation registry](README.md), and [PLAN.md](PLAN.md). The other five routed detail maps change only if implementation evidence invalidates one of their current claims.
