...
Artifact and registry ownership includes [the contract artifact cases](../scripts/contract-artifact-cases.ts), [profiles](../profiles/README.md), [scenarios](../scenarios/README.md), [contracts](../contracts/README.md), the semantic-core, BPMN-source, differential, Temporal-adapter, platform-contract, Definitions, Work, web, corpus, and showcase purpose-named READMEs or source maps, [the executable corpus](../model-corpus/manifest.json), and the root test-script registrations in [package.json](../package.json).
