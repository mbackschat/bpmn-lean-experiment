...
- boundary Compensation Event attachment/Association resolution, `isForCompensation`, Compensation Event Sub-Process snapshot provenance, and every source-to-retention declaration lowering
