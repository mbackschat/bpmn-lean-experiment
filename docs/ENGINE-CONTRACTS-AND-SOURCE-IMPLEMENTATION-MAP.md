...
A separate answer-free engine-population contract registers exact unique, zero, ambiguous, and cross-definition schedules for Lean, the independently written TypeScript core, and Temporal; CIB is explicitly absent. Corpus, Product 2, cost/reflection, and closure remain ahead.
