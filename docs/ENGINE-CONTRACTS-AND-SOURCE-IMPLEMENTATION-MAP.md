...
[Subscriptions](capsules/REPEATABLE-EVENT-SUBSCRIPTIONS-PROPOSAL.md): admission/codecs/lowering and Lean/core publication accepted; hosting and registered pipeline implemented, governed closure open.
...
- Compensation source/profile admission beyond the exact checkpoint topology, targeted or asynchronous throws, wider handler bodies or mappings, other dependency graphs, and every registered Compensation capability; private exact-source hosting establishes no public product support
