# Archived A12 add-on boundary proposal

## Status

Archived after same-reviewer audit approved closure correction `8d6ea1a` on 2026-08-09. The stable implemented contract now lives in the [A12 add-on boundary specification](../A12-ADD-ON-BOUNDARY-SPEC.md). This document retains the original question, proposed design, owner decision, and review chronology.
