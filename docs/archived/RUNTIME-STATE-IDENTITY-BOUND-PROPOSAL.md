...
- [`implementation-status-owner:ENGINE-SEMANTIC-INVARIANT`](../ENGINE-SEMANTIC-INVARIANT-IMPLEMENTATION-MAP.md) now records the local discharge beside the measured reason for the open preservation lane;
