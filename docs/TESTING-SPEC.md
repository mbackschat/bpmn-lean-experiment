...
- validates seven draft profiles, eleven answer-free scenarios, canonical results, retained CIB evidence where the declared target set includes CIB, checked BPMN graph, and Semantic Process program shapes with Ajv Draft 2020-12;
...
2. loads eleven answer-free scenarios and content-bound CIB evidence only for the ten scenarios whose declared target set includes CIB;
...
15. replays all eleven primary live histories plus the Service Task and CreateDocument failure-schedule histories;
