...
|---|---|---|
| Proposal | Normative interpretation, selected account, scope, exclusions, Temporal preflight, and separating counterexamples | Do not run implementation gates for lanes that do not exist |
