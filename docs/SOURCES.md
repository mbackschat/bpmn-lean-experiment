...
|---|---|---|
| CIB Seven Tasklist | [Current 2.2 Tasklist](https://docs.cibseven.org/manual/2.2/webapps/tasklist/), [current 2.2 focus and shortcut configuration](https://docs.cibseven.org/manual/2.2/webapps/configuration-options/), [current User Task forms](https://docs.cibseven.org/manual/latest/user-guide/task-forms/), and [historical 1.0 dashboard](https://docs.cibseven.org/manual/1.0/webapps/tasklist/dashboard/) | Current list, focus-region, assignment, Process-start, and form precedent; historical Form/Diagram sibling-tab evidence only |
