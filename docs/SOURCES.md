...
| Jackson `2.21.5` | Apache-2.0 | External Java JSON transport implementation in the local CIB oracle; the owner-approved 2026-07-30 patch upgrade aligns it with the advisory-clean family selected for the JUEL evaluator Worker |
