...
| BPMN presentation graph | Direct `bpmn-auto-layout@1.3.0`, `bpmn-moddle@10.0.0`, `min-dash@5.1.0`, and `saxen@11.1.0`, plus locked `moddle@8.2.0` and `moddle-xml@12.1.0`, are MIT | Adopted only in the Product 2 `@bpmn-lean/platform-bpmn-presentation` worker and parser boundary; no package enters Product 1, Lean, the semantic core, or Temporal |
