...
The retained gate digests above bind closure target `361911b8`, while the local tag resolves to `1c3243e8`; they therefore do not establish an exact-HEAD gate result after correction `8bcd8746`. This is an evidence-record gap rather than a retrospective semantic-failure claim. Tag creation now requires successful command receipts bound to the exact target commit, preventing the same gap at future phase and release boundaries.
