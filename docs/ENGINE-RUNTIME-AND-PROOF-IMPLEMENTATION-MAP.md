...
- checkpoint-approved body-claim admission and writer preservation; Parallel Multi-Instance closing remains open
...
- **Parallel Multi-Instance:** checkpoint, entry preservation, and approved [body-claim support](ACTIVITY-BODY-CLAIM-UNIQUENESS-PROPOSAL.md#first-green-implementation-checkpoint) exist; closing and family evidence remain open.
