...
- **Parallel Multi-Instance:** the approved first green checkpoint and entry-preservation proof are implemented, but closure is blocked by a body alias admitted by generic well-formedness. The draft [Activity body-claim uniqueness proposal](ACTIVITY-BODY-CLAIM-UNIQUENESS-PROPOSAL.md) owns the cross-family correction; the family evidence remains open.
