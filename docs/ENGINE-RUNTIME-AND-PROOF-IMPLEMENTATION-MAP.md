...
- **absent:** the Lean transition relations and evaluator soundness for all four arms, the Temporal host class and refinement witnesses, the capacity budget owner, and execution registration
