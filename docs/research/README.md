...
| Declarative semantics, reference interpreters, SpecTec mechanization experiments, portable conformance scripts, and transferable WebAssembly practices | [WebAssembly semantics architecture and BPMN transfer](WEBASSEMBLY-SEMANTICS-TRANSFER.md) |
