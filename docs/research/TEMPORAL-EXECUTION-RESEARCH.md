...
| Continue-As-New | Adopted for the bounded Product 1 Workflow chain | Production starts use approved budgets and one safe main-loop checkpoint; the forced cyclic witness proves observation-transparent state, identity, command recovery, terminal receipt, and replay across three Runs |
