...
The TypeScript SDK’s [activation sequence](../../oss/temporal/sdk-typescript/docs/activation.mermaid) shows the concrete boundary: Core polls a Workflow Task, creates an activation, the Node Worker decodes payloads, a Worker Thread advances the Workflow sandbox, Commands are collected, and the completion goes back through Core to the Service.
...
- Pinned implementation references: [Workflow API](../../oss/temporal/sdk-typescript/packages/workflow/src/workflow.ts), [Worker replay API](../../oss/temporal/sdk-typescript/packages/worker/src/worker.ts), [Sinks](../../oss/temporal/sdk-typescript/packages/worker/src/sinks.ts), [Data Converter](../../oss/temporal/sdk-typescript/packages/common/src/converter/data-converter.ts), and [SDK activation sequence](../../oss/temporal/sdk-typescript/docs/activation.mermaid)
