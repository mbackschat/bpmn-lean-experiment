...
The executable witness is [production-lifecycle.test.ts](../../packages/temporal-adapter/testkit/test/production-lifecycle.test.ts) and runs inside the focused Temporal gate:
