...
Next action: run clean integration before accepting the reviewed [regional/arming outcome](INTERNAL-COMMUTATION-PROPOSAL.md#regionalarming-outcome). The [mutation-Worker corrections](../packages/temporal-adapter/testkit/src/bypass-mutation.ts) retain late-startup ownership and join shutdown after termination failure, without changing deadlines. Retain all attempts and record acceptance in the [cost comparison](CAPSULE-COST-LEDGER.md#regionalarming-outcome-preparation-2026-09-21). The [completeness guard is deferred](PROCESS-ASSESSMENT-LEDGER.md#finding-63). Remaining pairs/batching stay open; E1/E2 change no RC scope.
