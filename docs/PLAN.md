...
- Lean scope-creation selection and retained-patch refinement. Command: `./scripts/lake.sh build BpmnSemantics.InternalScopeCreationSelectionConformance`. Status: `exit 0`. Date: `2026-09-18`. Commit: `bced19a5c11e258e6506b5caef043735933c5d3e`. The [immutable calibration](CAPSULE-COST-LEDGER.md#scope-creation-selection-calibration) passes under the unchanged 3 GiB ceiling; the complete 371-job Lean gate passes on the same source. Independent checkpoint review and complete repository verification remain pending.
