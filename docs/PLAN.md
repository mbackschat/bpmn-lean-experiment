...
Next action: close Compensation, incident, and aggregate runtime-validity preservation for successful child and Call [scope-creation preparations](INTERNAL-COMMUTATION-PROPOSAL.md#scope-creation-preparation-prerequisite). Derive successor validity from an admitted Program and well-formed predecessor rather than assuming it. Preparation, association, and position prerequisites are independently approved and completely verified; admitted-Program witnesses pass the unchanged 3 GiB ceiling. Then close complete preparation frames, commutation, accepted-publication correspondence, and production scope/region batching. Preserve exact complete-state equality, high-water records, and the distinction between collection algebra and transition preservation.
