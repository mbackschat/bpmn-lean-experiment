...
Next action: prove aggregate runtime-validity preservation for successful child and Call [scope-creation preparations](INTERNAL-COMMUTATION-PROPOSAL.md#scope-creation-preparation-prerequisite) from an admitted Program and well-formed running predecessor. Derive successor validity rather than assuming it. Complete preparation, retained-patch refinement, freshness, bounded Call reachability, association preservation, and admission/sorting prerequisites are independently approved and completely verified. Then close complete preparation frames, commutation, accepted-publication correspondence, and production scope/region batching. Preserve exact complete-state equality, high-water records, and the distinction between collection algebra and transition preservation.
