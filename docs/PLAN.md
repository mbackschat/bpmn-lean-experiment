...
Next action: audit complete preparation-frame gaps against existing selection, fixed-mask, region, footprint, and publication laws before adding machinery. Select one complete frame deliverable and its separating pair witness; reassess before any substantial prerequisite expansion. [Complete/Return preservation and retained Activity owners](INTERNAL-COMMUTATION-PROPOSAL.md#complete-and-return-runtime-preservation) are independently approved at `f725745d`, with clean complete integration. [Error/Terminate preservation](INTERNAL-COMMUTATION-PROPOSAL.md#error-and-terminate-runtime-preservation) is approved at `0f4e8a51`. E1/E2 change no RC scope.
