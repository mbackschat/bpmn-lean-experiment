...
Next action: implement complete scope/region preparation under the approved [Internal Commutation account](INTERNAL-COMMUTATION-PROPOSAL.md#final-closure-evidence-and-adversarial-oracles), starting from predecessor-derived child-scope and Call-invocation patches before regional batch integration. The [canonical scope and counter-storage prerequisite](INTERNAL-COMMUTATION-PROPOSAL.md#canonical-scope-and-counter-storage-checkpoint) is independently approved and completely verified at `da9657e0`; [immutable resource calibration](CAPSULE-COST-LEDGER.md#canonical-scope-storage-immutable-calibration) and module-cost binding cover its committed source. Preserve exact complete-state equality, high-water records, and the distinction between collection algebra and transition preservation.
