...
Next action: complete immutable resource calibration, independent cold review, and the clean complete gate for the [place-wide token-owner census checkpoint](INTERNAL-COMMUTATION-PROPOSAL.md#place-wide-token-owner-census-checkpoint). The [review receipt](INTERNAL-COMMUTATION-PROPOSAL.md#independent-cold-review-receipt) owns stage status. This prerequisite supplements owner-specific buckets and enables no additional production family. After it closes, continue canonical token storage before token-producing and regional families join batches. Regions, scheduled choice, and final closure remain open; the [cold library memory correction](CAPSULE-COST-LEDGER.md#package-wide-theorem-elaboration-memory-correction) retains the unchanged 3 GiB ceiling.
