...
Next action: complete accepted lifecycle publication for [scope creation](INTERNAL-COMMUTATION-PROPOSAL.md#scope-creation-preparation-prerequisite), then production scope/region batching. Derive successor open projection and actual acceptance from predecessor validity, open projection, and preparation; preserve private boundary-Timer classification through the static entry census. The [Call pairing correction](capsules/CALL-ACTIVITY-SPEC.md#independent-cold-review-receipt), complete-state commutation, and control-position correspondence are independently approved and fully verified. Preserve high-water records, predicate coverage, and the 3 GiB ceiling.
