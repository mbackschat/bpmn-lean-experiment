...
**Latest complete gate: 2026-08-08, exit 0 at `fb4b7dc`.** All **35** registered cases reached agreement across their declared targets, all 35 seeded semantic mutations produced their required disagreement, all 18 retained-CIB evidence comparisons agreed, and all 37 live histories passed. Its 22167.165708ms warm pipeline total is **correctness evidence only**, not a baseline: other programs were using substantial CPU during the run. The preceding complete gate was `3b75aed` at 35 cases and 19925.6515ms, also contended.
...
**Last verified command:** `./scripts/verify.sh`, exit 0, at `fb4b7dc`, with 35 agreements, 35 seeded mutations detected, 18 retained-CIB comparisons, and 37 live histories. Its timing is contended and is not a baseline; see [the baselines above](#last-verified-baseline).
