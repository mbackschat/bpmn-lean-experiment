...
**Last verified commands:** `/usr/bin/time -p env CI=true ./scripts/verify.sh` passed at immutable Terminate End closure target `2d75149` in 197.19 seconds with output SHA-256 `eaf40aab897b76cf435f4928c4f7692d4a5c38f05a97a836ffe938a7563c5885`; the complete pipeline replayed 43 live histories. The full-gate Terminate witness recorded a 20-event replayable history and 10,750 service-reported bytes, with the byte size remaining run-specific. The independent closure reviewer reran BPMN source 427/427, semantic checks with TypeScript 189/189, contracts 46/46, differential 20/20, focused documentation/status/cost 46/46, and live Terminate evidence 2/2. The mandatory Linux/arm64 Lean admission audit passed with Lean 4.31.0 under one CPU, a 3 GiB memory-and-swap ceiling with effective swap disabled, and no OOM: 26.82 seconds wall, 2,648,276 KiB maximum RSS, and 2,336,649,216 bytes cgroup peak. The complete platform M1 gate passed in 14.53 seconds, and the registered M1 showcase passed in 9.11 seconds.
