...
Next action: close the [subscription draft's design obligations](capsules/REPEATABLE-EVENT-SUBSCRIPTIONS-PROPOSAL.md#open-design-obligations), starting with exact admission and source-reachable frontiers, then ingress linearization and Timer continuation. Complete the consumer inventory and quantified-law boundary before independent proposal review. The draft selects no production work. Snapshot arming and private pipeline correspondence are accepted; future subscription/Transaction combinations remain unresolved. Preserve the bounded Sub-Process checkpoint and regional trial. No additional proof infrastructure is selected.
