...
- Activity-data projection prerequisite. Command: `./scripts/pnpm.sh run test:pre-push`. Status: `exit 0`, clean worktree. Date: `2026-09-06`. Commit: `13dfe438898bd3dc95283de9cf9fa32f984e54e9`. Output SHA-256: `a8d7e33152fd35de2dda5658204da2b946a6d5bff24f96e90bf41ce5a2cd850f`. The [independent checkpoint audit](INTERNAL-COMMUTATION-PROPOSAL.md#independent-cold-review-receipt) approved the correction with no remaining findings. All 306 maintained Lean targets and 72 pipeline cases pass; this establishes no Activity-data commutation law.
...
Next action: finish verification and integration of the composed Activity-data preparation prerequisite under the approved [Internal Commutation final-closure account](INTERNAL-COMMUTATION-PROPOSAL.md#selected-final-closure-account). Its [evidence owner](INTERNAL-COMMUTATION-PROPOSAL.md#final-closure-evidence-and-adversarial-oracles) now binds preparation, sibling preservation, raw patch commutation, runtime/open-projection preservation, and accepted publication. Retain the unavailable production footprint until the complete footprint contract and execution integration are proved; then close arbitrary finite independent batches, region families, and explicit scheduled choice in the approved dependency order.

The prerequisite [Lean open-set projection correction](INTERNAL-COMMUTATION-PROPOSAL.md#final-closure-evidence-and-adversarial-oracles) restores exact projection for the three existing Activity-data operation variants. Its complete gate and independent checkpoint audit are approved; proceed with the preparation lane above.
