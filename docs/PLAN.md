...
Next action: independently review and completely verify the new child/Call [preparation frame laws](INTERNAL-COMMUTATION-PROPOSAL.md#scope-creation-preparation-prerequisite); the complete Lean gate and immutable calibration pass. They derive unchanged opposite preparation from predecessor validity and footprint separation; constructed witnesses establish structural validity without source-profile admission. After acceptance, close commutation, accepted-publication correspondence, and production scope/region batching. Preserve complete-state equality, high-water records, existing predicate coverage, and the unchanged 3 GiB ceiling.
