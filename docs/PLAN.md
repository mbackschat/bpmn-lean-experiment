...
Next action: complete the composed Activity-data footprint contract and execution integration under the approved [Internal Commutation final-closure account](INTERNAL-COMMUTATION-PROPOSAL.md#selected-final-closure-account). The [preparation prerequisite](INTERNAL-COMMUTATION-PROPOSAL.md#final-closure-evidence-and-adversarial-oracles) and its independent checkpoint review are complete. Retain the unavailable production footprint until its full contract is proved; then close arbitrary finite independent batches, region families, and explicit scheduled choice in the approved dependency order.
