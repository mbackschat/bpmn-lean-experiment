...
The [answer-free scenario](scenario.json) executes the byte-identical [BPMN source](process.bpmn) admitted by the [BPMN 2.0.2 cycle profile](../../profiles/bpmn-2.0.2-user-task-cycle-draft/profile.json) and governed by the [cyclic-control-flow specification](../../docs/capsules/CYCLIC-CONTROL-FLOW-SPEC.md).
