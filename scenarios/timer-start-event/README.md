...
The [answer-free scenario](scenario.json) executes the byte-identical [BPMN source](process.bpmn) admitted by the [BPMN 2.0.2 Timer Start Event profile](../../profiles/bpmn-2.0.2-timer-start-event-draft/profile.json) and governed by the [Timer Start Event specification](../../docs/capsules/TIMER-START-EVENT-SPEC.md).
