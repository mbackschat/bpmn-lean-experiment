...
This directory contains the project-authored BPMN fixture and three answer-free schedules for the [Terminate End Event specification](../../docs/capsules/TERMINATE-END-EVENT-SPEC.md). The BPMN bytes are identical to the source-admission fixture.
