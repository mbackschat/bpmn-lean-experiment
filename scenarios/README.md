...
- The [Message payload catch mediation source](message-payload-catch/README.md) supplies the exact shared ItemDefinition, operation-addressed Message, Event-owned required DataOutput, OutputSet membership, direct Process Property association, and separating control route used by the source/IL checkpoint. Answer-free execution scenarios remain outside this checkpoint.
