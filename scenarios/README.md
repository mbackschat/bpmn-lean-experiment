...
- The [Message key-correlation checkpoint source](message-key-correlation/README.md) supplies only the exact settlement-confirmation BPMN graph for source/checked/IL and independently approved semantic-checkpoint evidence. It remains unregistered until the later scenario and closure lane.
