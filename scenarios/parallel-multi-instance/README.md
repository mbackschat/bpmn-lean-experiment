...
- The [interrupted schedule](interrupted.scenario.json) completes one review, fires the shared outer `PT1S` deadline, and then submits a stale completion that must be refused.
