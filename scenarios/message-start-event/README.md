...
The [answer-free scenario](scenario.json) executes the byte-identical [BPMN source](process.bpmn) admitted by the [BPMN 2.0.2 Message Start Event profile](../../profiles/bpmn-2.0.2-message-start-event-draft/profile.json) and governed by the [Message Start Event proposal](../../docs/capsules/MESSAGE-START-EVENT-PROPOSAL.md).
