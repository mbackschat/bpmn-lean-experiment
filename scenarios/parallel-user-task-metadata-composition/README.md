...
The [parallel User Task metadata composition proposal](../../docs/capsules/PARALLEL-USER-TASK-METADATA-COMPOSITION-PROPOSAL.md) owns the exact source restriction, passive metadata meaning, accepted command ordering, and exclusions.
