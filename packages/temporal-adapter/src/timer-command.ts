...
export function timerFiringCommandId(
  ...
  return `fire-timer-sha256:${
    sha256Hex(canonicalTimerFiringEncoding(timerId, logicalTimeMs))
  }`;
}
...
/**
 * Dependency-free SHA-256 for the deterministic Workflow sandbox. Node crypto is intentionally
 * unavailable because replay recomputes this command from history-backed semantic state.
 */
