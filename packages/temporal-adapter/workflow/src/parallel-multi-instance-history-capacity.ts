  ...
  ParallelMultiInstanceServiceHistoryMeasurement = Object.freeze({
    ...
    topologies: [
      retainedServiceTopology(
        ...
        0,
        [
          ["open", 9, 14_802, 13_540],
          ["complete-1", 14, 16_743, 921],
          ["complete-2", 19, 18_683, 925],
          ["complete-3", 24, 20_624, 925],
          ["complete-4", 29, 22_565, 925],
          ["complete-5", 34, 24_506, 925],
          ["complete-6", 39, 26_447, 925],
          ["complete-7", 44, 28_387, 923],
          ["complete-8", 49, 30_326, 922],
          ["complete-9", 54, 32_265, 922],
          ["complete-10", 59, 34_204, 922],
          ["complete-11", 64, 36_143, 922],
          ["complete-12", 69, 38_082, 922],
          ["complete-13", 74, 40_021, 922],
          ["complete-14", 79, 41_960, 922],
          ["complete-15", 84, 43_899, 922],
          ["terminal", 91, 65_968, 19_991],
        ],
        [91, 65_968, 392_727, 9, 19_991],
        [1, 51, 2, 2, 16, 16, 1, 1, 0, 0, 1],
      ),
      retainedServiceTopology(
        ParallelMultiInstanceCapacityTopology.TimerInterruption,
        15,
        [
          ["open", 9, 14_822, 13_560],
          ["one-completed", 14, 16_783, 951],
          ["timer-fired", 18, 17_321, 9_068],
          ["stale-refused", 23, 19_286, 954],
          ["terminal", 29, 30_444, 9_705],
        ],
        [29, 30_444, 132_344, 9, 13_560],
        [1, 15, 2, 2, 3, 3, 1, 0, 1, 0, 1],
      ),
      retainedServiceTopology(
        ParallelMultiInstanceCapacityTopology.EarlyCompletion,
        15,
        [
          ["open", 9, 14_820, 13_558],
          ["terminal", 16, 26_261, 9_351],
        ],
        [16, 26_261, 79_094, 9, 13_558],
        [1, 6, 2, 2, 1, 1, 1, 1, 0, 0, 1],
      ),
    ],
  } as const);
