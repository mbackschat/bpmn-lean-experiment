...
- [Sequential Multi-Instance proposal](../../docs/capsules/SEQUENTIAL-MULTI-INSTANCE-PROPOSAL.md) owns the exact managed-deadline and production-refinement boundary while closure review is pending.
