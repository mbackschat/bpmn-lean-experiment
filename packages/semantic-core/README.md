...
- [Compensation trigger and handler proposal](../../docs/capsules/COMPENSATION-TRIGGER-HANDLER-PROPOSAL.md) owns the strict Program declaration and dormant trigger operation now admitted by the core; RuntimeState, restoration, handler-frontier execution, failure, cancellation, and hosting remain the next semantic-checkpoint work.
