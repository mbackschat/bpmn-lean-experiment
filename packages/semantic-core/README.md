...
| [semantic-process-message-start.ts](src/semantic-process-message-start.ts) | Exact resolved Message-start pairing, fresh root admission, generic canonical outgoing-token production, and no-subscription boundary |
