...
- [Sequential Multi-Instance proposal](../../docs/capsules/SEQUENTIAL-MULTI-INSTANCE-PROPOSAL.md) owns the structurally admitted operation and the deliberately unregistered runtime profile.
