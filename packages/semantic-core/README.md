...
- [Activity data-input/output mediation proposal](../../docs/capsules/ACTIVITY-DATA-INPUT-OUTPUT-MEDIATION-PROPOSAL.md) owns the distinct composed operation, one input-bearing Activity-local lifetime, exact output completion, association-routed Process write, and atomic cleanup contract.
