...
- [Sequential Multi-Instance proposal](../../docs/capsules/SEQUENTIAL-MULTI-INSTANCE-PROPOSAL.md) owns the exact registered controller, transition, observation, and exclusion boundary while closure review is pending.
