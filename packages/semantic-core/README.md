...
- [Compensation trigger and handler proposal](../../docs/capsules/COMPENSATION-TRIGGER-HANDLER-PROPOSAL.md) owns the strict Program declaration plus the representation-only RuntimeState and public-result slice: optional trigger/handler collections, frozen parent context on deferred and active Event Sub-Process handlers, declaration-bound validity and exact capacity, and typed failed Process observation/receipt propagation. Trigger construction, restoration, handler-frontier execution, failure production, cancellation semantics, and hosting remain the next semantic-checkpoint work.
