...
export enum InternalRuntimeStateAtomDomain {
  ...
  CompensationHandlerEffectWait = "compensationHandlerEffectWait",
  Variable = "variable",
...
export const internalRuntimeStateFieldCensus = {
  ...
  compensationActivityRetentions: { leanField: "compensationActivityRetentions", atomDomain: InternalRuntimeStateAtomDomain.CompensationActivityRetention },
  compensationParentContextRetentions: { leanField: "compensationParentContextRetentions", atomDomain: InternalRuntimeStateAtomDomain.CompensationParentContextRetention },
  compensationTriggers: { leanField: "compensationTriggers", atomDomain: InternalRuntimeStateAtomDomain.CompensationTrigger },
  compensationHandlerEffectWaits: { leanField: "compensationHandlerEffectWaits", atomDomain: InternalRuntimeStateAtomDomain.CompensationHandlerEffectWait },
