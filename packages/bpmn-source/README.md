...
- [Sequential Multi-Instance proposal](../../docs/capsules/SEQUENTIAL-MULTI-INSTANCE-PROPOSAL.md) owns the exact source/IL checkpoint and the still-absent runtime semantics.
